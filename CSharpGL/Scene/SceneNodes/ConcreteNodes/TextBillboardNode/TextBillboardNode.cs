...
namespace CSharpGL {
    ...
    public partial class TextBillboardNode : ModernNode {
        ...
        public static TextBillboardNode Create(int width, int height, int capacity, GlyphServer? glyphServer = null) {
            var vs = Shader.Create(Shader.Kind.VertexShader, vertexCode, out var _);// this vertex shader has no vertex attributes.
            var fs = Shader.Create(Shader.Kind.FragmentShader, fragmentCode, out var _);
