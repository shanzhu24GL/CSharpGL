...
namespace CSharpGL {
    ...
    public static unsafe partial class TextureHelper {
        ...
        /// <returns></returns>
        public static unsafe GLBitmap GetImage(this Texture texture, int width, int height, int level = 0) {
        ...
        /// <param name="level"></param>
        /// <returns></returns>
        public static unsafe GLBitmap GetImage(this Texture texture, CubemapFace face, int width, int height, int level = 0) {
            var bmp = new GLBitmap(width, height, 4);
            var gl = GL.current; if (gl == null) { return bmp; }
            texture.Bind();
