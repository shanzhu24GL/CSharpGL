...
namespace CSharpGL {
    ...
    public unsafe class TexImageBitmaps : TexStorageBase {
        ...
        /// 
        /// </summary>
        public readonly GLBitmap[] layers;
        /// <summary>
        /// 
        /// </summary>
        ...
        public TexImageBitmaps(GLBitmap[] layers, uint internalFormat = GL.GL_RGBA8, int mipmapLevelCount = 1, bool border = false)
        ...
        public TexImageBitmaps(int width, int height, int layerCount, uint internalFormat = GL.GL_RGBA8, int mipmapLevelCount = 1, bool border = false)
            ...
            this.layers = new GLBitmap[layerCount];
            this.width = width;
            this.height = height;
            ...
            if (layers != null) {
                ...
                for (int layerIndex = 0; layerIndex < layers.Length; layerIndex++) {
                    ...
                    // first mipmap.
                    {
                        ...
                        gl.glTexSubImage3D((uint)this.target, level, xoffset, yoffset, layerIndex, this.width, this.height, depth, GL.GL_BGRA, GL.GL_UNSIGNED_BYTE, layer.scan0 /*pixels*/);
                    ...
                    for (int level = 1; level < mipmapLevelCount; level++) {
                        ...
                        gl.glTexSubImage3D((uint)this.target, level, xoffset, yoffset, layerIndex, bmp.width, bmp.height, depth, GL.GL_BGRA, GL.GL_UNSIGNED_BYTE, bmp2.scan0);
                        //bmp.UnlockBits(data);
                        //bmp.Dispose();
