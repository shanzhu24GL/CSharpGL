...
namespace CSharpGL {
    ...
    public unsafe class CubemapDataProvider : TexImageDataProvider<CubemapData>, IDisposable {
        private readonly GLBitmap positiveX;
        private readonly GLBitmap negtiveX;
        private readonly GLBitmap positiveY;
        private readonly GLBitmap negtiveY;
        private readonly GLBitmap positiveZ;
        private readonly GLBitmap negtiveZ;
        ...
        public CubemapDataProvider(
            GLBitmap positiveX, GLBitmap negtiveX,
            GLBitmap positiveY, GLBitmap negtiveY,
            GLBitmap positiveZ, GLBitmap negtiveZ,
        ...
        private void Dispose(bool disposing) {
            if (this.disposedValue == false) {
                ...
                if (this.autoDispose) {
                    var array = new GLBitmap[] { this.positiveX, this.negtiveX, this.positiveY, this.negtiveY, this.positiveZ, this.negtiveZ, };
