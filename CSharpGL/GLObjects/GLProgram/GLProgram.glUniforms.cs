    ...
    public unsafe partial class GLProgram {
        ...
        internal int glUniform(string uniformName, mat4 m) {
            ...
            if (location >= 0) {
                ...
                gl.glUniformMatrix4fv(location, 1, false, array); // NOTE: assign'uniform mat4 M[4];' in instanced rendering.
            }
            return location;
        }
        ...
        internal int glUniform(string uniformName, mat4[] matrixes) {
            ...
            if (location >= 0) {
                ...
                gl.glUniformMatrix4fv(location, matrixes.Length, false, values);
            }
            return location;
        }
        ...
        internal int glUniformMatrix4(string uniformName, float[] m) {
            ...
            if (location >= 0) {
                ...
                var gl = GL.current; if (gl == null) { return -1; }
                gl.glUniformMatrix4fv(location, m.Length / 16, false, m);
            }
            return location;
        }
    }
